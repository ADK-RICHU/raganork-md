...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~59c264ab9bd439c1d372d739f299cfca:717a41345732774a6344513d")
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/492557f2589925dc372c1.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'ᴉᴛᴢ ᴍᴇ ᴀᴅᴋ_ʀᴉᴄʜᴜ;ADK 리츄;https://telegra.ph/file/492557f2589925dc372c1.jpg;https://chat.whatsapp.com/I9WpnuNlTj8ELutpU4qfl7',
    RBG_KEY: process.env.RBG_KEY || 'HYmAaY7vw3qaBPcct1eSgYgT',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ADK 리츄",
    BOT_NAME: process.env.BOT_NAME || 'ADK 리츄',
    ...
    ANTILINK_WARN: process.env.ANTILINK_WARN || '4',
    HEROKU: {
